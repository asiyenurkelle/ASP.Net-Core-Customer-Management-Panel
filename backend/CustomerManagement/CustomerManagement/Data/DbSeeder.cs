...
namespace CustomerManagement.Data
{
    public class DbSeeder
    {
        ...
        readonly CustomerContext _Context;

        public DbSeeder(ILoggerFactory loggerFactory, CustomerContext Context)
        {
            _Logger = loggerFactory.CreateLogger("DbInitializerLogger");
            _Context = Context;
        }
        ...
        public async Task InsertCustomersSampleData (CustomerContext db)
        {
            ...
            {
                _Logger.LogError($"Error in {nameof(CustomerContext)}:" + exp.Message);
                throw;
            }
        ...
        private List<State> GetStates()
        {
            var states = new List<State>
            {
                ...
                new State {Name="NewHaöshire",Abbreviation="NH"},
                ...
                new State {Name="Conecticut",Abbreviation="CT"},
                new State {Name="New York",Abbreviation="NY"},
                new State {Name="Alabama",Abbreviation="DE"},
                new State {Name="Delaware",Abbreviation="NC"},
                new State {Name="North Carolina ",Abbreviation="AL"},
                ...
                new State {Name="Missourl",Abbreviation="MO"},
